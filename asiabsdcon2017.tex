...
\usepackage{usenix,epsfig,endnotes,listings,graphicx}
\begin{document}
...
https://<job url>/<build number>/testReport (fig. 2, 3), and maintains a
historical data (fig. 4). This helps us tracking the software quality trending.
